...
namespace BsseCode._6._Audio.Managers
{
    public class AudioEffectsController : MonoBehaviour
    {
        ...
        private const string VolumePrefKey = "EffectVolume"; // Ключ для сохранения в PlayerPrefs
        ...
        private void Update()
        {
            ...
            FMODUnity.RuntimeManager.StudioSystem.getParameterByName("EffectVolume", out float externalVolume);
        ...
        {
            FMODUnity.RuntimeManager.StudioSystem.setParameterByName("EffectVolume", volume);
        }
    }
}
