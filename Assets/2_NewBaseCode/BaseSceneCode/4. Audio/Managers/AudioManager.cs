...
namespace _2_NewBaseCode.BaseSceneCode._4._Audio.Managers
{
    ...
    {
        SoundPool InitializeSoundPool(EventReference soundPath, int initialCount = 5);
        void PlaySound(EventReference soundPath, bool useInstance = false, Vector3? position = null);
        void StopSound(EventReference soundPath);
        void StopAllSounds();
        EventInstance PlaySoundWithInstance(EventReference soundPath, bool useInstance = false, Vector3? position = null);
    }
}
